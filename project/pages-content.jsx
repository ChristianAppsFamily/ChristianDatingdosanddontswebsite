...
const GOSPEL_SECTIONS = [
  ...
  },
  {
    ...
    body: 'Though created good, humanity fell through disobedience. Every person since Adam has inherited a sinful nature and chosen sin personally. We do not merely make mistakes; we violate God\'s law in thought, word, and deed. No one is righteous on their own. Our sin separates us from the holy God who made us.',
  },
  {
...
const STATEMENT_OF_FAITH = [
    ...
    subsections: [
      {
        ...
        paragraphs: [
          ...
          'We teach that God\'s election of totally depraved sinners is unconditional, grounded only in the sovereign freedom of God\'s own will. Election is an expression of God\'s unmerited favor and is not related to any initiative of the sinner\'s own part (Romans 9:11, 16; Ephesians 1:4–7; Titus 3:4–7; 1 Peter 1:2).',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We teach that the church is thus a unique spiritual organism designed by Christ, made up of all regenerate persons in this present age (Ephesians 2:11–3:6). The church is distinct from Israel (1 Corinthians 10:32), a mystery not revealed until this age (Ephesians 3:1–6; 5:32).',
      ...
      'We teach that two ordinances have been committed to the local church: baptism and the Lord\'s Supper (Acts 2:38–42). Christian baptism by immersion (Acts 8:36–39) is the solemn and beautiful testimony of a believer showing forth his faith in the crucified, buried, and risen Savior (Romans 6:1–11).',
  ...
  },
  {
    ...
    subsections: [
      ...
      {
        id: 'the-second-coming',
        title: 'The Second Coming',
        paragraphs: [
          'We teach that, after the tribulation period, Christ will come to earth to occupy the throne of David (Matthew 25:31; Luke 1:31–33; Acts 1:10–11; 2:29–30; cf. Revelation 3:21) and establish His messianic kingdom for a thousand years on the earth (Revelation 20:1–7). During this time the resurrected saints will reign with Him over Israel and all the nations of the earth (Ezekiel 37:21–28; Daniel 7:17–22; Revelation 19:11–16).',
        ],
      },
      {
        id: 'the-judgment',
...
const FAITH_SIDEBAR = [
  { id: 'the-holy-scriptures', label: 'The Holy Scriptures' },
  { id: 'god', label: 'God' },
  { id: 'god-the-father', label: 'God the Father' },
  { id: 'god-the-son', label: 'God the Son' },
  { id: 'god-the-holy-spirit', label: 'God the Holy Spirit' },
  { id: 'man', label: 'Man' },
  { id: 'salvation', label: 'Salvation' },
  { id: 'the-church', label: 'The Church' },
  { id: 'angels', label: 'Angels' },
  { id: 'last-things', label: 'Last Things' },
  { id: 'the-gospel', label: 'The Gospel' },
];

Object.assign(window, { GOSPEL_SECTIONS, STATEMENT_OF_FAITH, FAITH_SIDEBAR });
